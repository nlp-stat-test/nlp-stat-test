def helper(function_name: str) -> str:
    advice =\
    {
        ...
        "cohend" : "The Cohen's d estimates the standardized mean difference and is appropriate for normal samples.",
        "hedgesg" : "The Hedges's g index also estimates the standardized mean difference but is adjusted based on Cohen's d for a slight bias in small samples.",
        "wilcoxon_r" : "The standardized z-score (r) for the Wilcoxon signed-rank test.",
        "hodgeslehmann" : "The Hodges-Lehmann estimates the population median of a symemtric distribution. It is an unstandardized index.",
